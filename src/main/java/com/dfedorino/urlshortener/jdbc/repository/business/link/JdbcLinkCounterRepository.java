...
public class JdbcLinkCounterRepository implements LinkCounterRepository {
    ...
    public static final String INCREMENT_COUNTER = "UPDATE link_counter SET counter = counter + 1"
            + " WHERE id = 1";
    public static final String SELECT_BY_ID = "SELECT counter FROM link_counter"
            + " WHERE id = 1";
