...
class JdbcHousekeepingLinkRepositoryTest extends AbstractJdbcRepositoryTest {
  ...
  void updateStatusId() {
    ...
    tx(() -> housekeepingLinkRepository.updateStatusId(link.getId(), LinkStatus.INVALID.getId()));
